...
namespace AzureDevOpsForager.Core.Misc
{
   ...
   public class Global
   {
      ...
      /// <c>Config.AzureUrl</c>.
      /// </summary>
      public static readonly string _azureDevOpsUrl = Environment.GetEnvironmentVariable( "AZDO_URL" ) ?? "";
      ...
      /// </summary>
      public static readonly string _azureDevOpsPAT = Environment.GetEnvironmentVariable( "AZDO_PAT" ) ?? "";
