...
namespace AzureDevOpsForager.Shared.UI
{
   ...
   /// groups. Child controls added to it sit inside the padding, below the header. Pure System.Drawing/Drawing2D;
   /// no libraries. (Ported from the Indexer form so the chat window matches the same look.)
   /// </summary>
